...
path = "/Users/sunnygao/Desktop/midterm_project/test_data_IMDB_Fall_2023.csv"
imdb <- read.csv(path)

path_plot = "/Users/sunnygao/Desktop/midterm_project/preprocessing/pre_plot.csv"
plot <- read.csv(path_plot)
plot <- plot[9603:9662,] # test set only
...
path_output = "/Users/sunnygao/Desktop/midterm_project/preprocessing/test_set_first_step_cleaning.csv"
