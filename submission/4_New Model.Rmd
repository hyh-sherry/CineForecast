...
```{r}
stargazer(model_final_lm_all,title="Results", align=TRUE,
          dep.var.labels=c("IMDb Score"), 
          covariate.labels=c("Release Year", "Movie Budget", 
                              "duration_bs_term1","duration_bs_term2", "duration_bs_term3",
                             "duration_bs_term4", "duration_bs_term5", "duration_bs_term6",
                             "Country-USA", "Maturity Rating-PG",
                              "Maturity Rating-R", "Number of Articles in News", "Number of Faces on Poster", 
                              "Genre-Action", "Genre-Thriller", "Genre-Horror", "Genre-Drama", "Genre-Animation",
                             "2023 Movie Rating", "Genre-Biography", "Genre-Comedy", "Genre-Documentary",
                             "Director-Medium", "Director-MediumPlus", "Director-Other",
                             "Actor1-Medium", "Actor1-MediumPlus", "Actor1-Other"
                             ), digits = 2)
```
